...
function TravelPlannerPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-2 flex flex-col justify-center items-center">
      <h1 className="text-2xl font-bold text-center mb-4">여행 일정 만들기</h1>
      <div className="flex justify-center items-center w-full gap-2 border-t border-mainColor">
        <div>
          <div className="flex justify-between items-centerpt-2 mt-2">
            <div className="mr-2">
              여행 제목
              <Input
                type="text"
                ...
                className="w-full border rounded px-3 py-2 text-sm min-w-40"
              />
            </div>
          ...
          <div className="flex justify-center mt-2 gap-2 w-full">
            <div className="p-4 border border-mainColor rounded-lg w-full">
              ...
              <div className="flex justify-cente mt-2">
                ...
                <textarea
                  className="border rounded-lg ml-2 text-xs min-w-36 p-2 resize-none focus:outline-none focus:ring-0"
