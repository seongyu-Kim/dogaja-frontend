...
import { FaRegListAlt, FaRegUser, FaRegCalendarAlt, FaLongArrowAltLeft } from "react-icons/fa";

export default function Sidebar() {
  return (
    <aside className="w-20 border-r-4 border-mainColor text-mainColor h-screen">
